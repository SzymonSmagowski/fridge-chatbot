...
/**
 * Animated ambient layer that lives behind every view inside the device screen.
 * Four drifting blurred blobs + a soft diagonal sunbeam sweep + floating motes.
 *
 * Respects prefers-reduced-motion via the scoped global rule in preview.module.css
 * (all animations become ~0ms).
 */
